...
@ApiModel(description = "Response payload for flow status")
public class FlowConfigResponse {
     ...
     * Type of the flow.
     **/
    public FlowConfigResponse flowType(String flowType) {
        this.flowType = flowType;
        return this;
    }

    @ApiModelProperty(example = "REGISTRATION", required = true, value = "Type of the flow.")
     ...
     **/
    public FlowConfigResponse isEnabled(Boolean isEnabled) {
        this.isEnabled = isEnabled;
        return this;
    }

    @ApiModelProperty(example = "false", required = true, value = "Whether the flow is enabled.")
    ...
    /**
     * Whether auto-login is enabled for the flow.
     **/
    public FlowConfigResponse isAutoLoginEnabled(Boolean isAutoLoginEnabled) {
        this.isAutoLoginEnabled = isAutoLoginEnabled;
        return this;
    }

    @ApiModelProperty(example = "false", required = true, value = "Whether auto-login is enabled for the flow.")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FlowConfigResponse)) return false;
        FlowConfigResponse that = (FlowConfigResponse) o;
